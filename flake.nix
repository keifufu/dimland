{
  ...
  outputs = inputs @ {
    ...
    flake-parts.lib.mkFlake {inherit inputs;} {
      ...
      in rec {
        packages.default = packages.dimland;
        packages.dimland = pkgs.rustPlatform.buildRustPackage {
          pname = manifest.name;
        ...
        packages.dim = pkgs.writeShellApplication {
          name = "dim";
          runtimeInputs = [packages.dimland];
          text = builtins.readFile ./src/dim;
        };
